//investigar @tanstack/react-table
//zod
"use client";
...
const InventoryTable: React.FC = () => {
  ...
  const handleExportExcel = async () => {
    ...
    titleCell.value = "REPORTE DE INVENTARIO ACTUALIZADO";
    ...
    headerRow.eachCell((cell) => {
      cell.fill = {
        type: "pattern",
        pattern: "solid",
        fgColor: { argb: "D9D9D9" }, // gris suave
      };
    });
    ...
    saveAs(new Blob([buffer]), `reporte_inventario_${fecha}.xlsx`);
  };
        ...
        <div className="mb-8 flex items-center justify-between">
          ...
          <div className="flex gap-1">
            ...
            <button
              ...
              className="inline-flex items-center gap-1 rounded-lg bg-green-700 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-green-600"
            >
