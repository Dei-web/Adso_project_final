...
import { UpdateClient, GetVehicleClient, CreateVehicle } from "../types/models/entity";

export async function getVehicleById(id: string): Promise<GetVehicleClient | null> {
...
export async function updateVehicle(id: string, input: UpdateClient) {
    const vehicleId = parseInt(id, 10);
