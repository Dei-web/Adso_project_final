...
CREATE TABLE "InformationPieces" (
    "id" SERIAL NOT NULL,
    "dateOf_entry" TIMESTAMP(3) NOT NULL,
...
-- CreateTable
CREATE TABLE "UbicationPiece" (
    "id" SERIAL NOT NULL,
    "ubication" VARCHAR(50) NOT NULL,
    "createAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "UbicationPiece_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "InvoiceDetail_invoiceDetail_id_key" ON "InvoiceDetail"("invoiceDetail_id");

-- CreateIndex
CREATE UNIQUE INDEX "SuppliersContact_proveedorId_key" ON "SuppliersContact"("proveedorId");

-- AddForeignKey
ALTER TABLE "Credentials" ADD CONSTRAINT "Credentials_sessionId_fkey" FOREIGN KEY ("sessionId") REFERENCES "Session"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "InvoiceDetail" ADD CONSTRAINT "InvoiceDetail_invoiceDetail_id_fkey" FOREIGN KEY ("invoiceDetail_id") REFERENCES "Invoice"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "InvoiceDetail" ADD CONSTRAINT "InvoiceDetail_pieceId_fkey" FOREIGN KEY ("pieceId") REFERENCES "Pieces"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "InvoiceDetail" ADD CONSTRAINT "InvoiceDetail_serviceId_fkey" FOREIGN KEY ("serviceId") REFERENCES "Services"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Services" ADD CONSTRAINT "Services_serviceCategory_id_fkey" FOREIGN KEY ("serviceCategory_id") REFERENCES "ServiceCategory"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Pieces" ADD CONSTRAINT "Pieces_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "PieceCategory"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Pieces" ADD CONSTRAINT "Pieces_ubicationId_fkey" FOREIGN KEY ("ubicationId") REFERENCES "UbicationPiece"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "InformationPieces" ADD CONSTRAINT "InformationPieces_moreInformation_id_fkey" FOREIGN KEY ("moreInformation_id") REFERENCES "Pieces"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AvailablePieces_vehicle" ADD CONSTRAINT "AvailablePieces_vehicle_pieceVehiculo_id_fkey" FOREIGN KEY ("pieceVehiculo_id") REFERENCES "Pieces"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
