...
-- AddForeignKey
ALTER TABLE "AppointmentScheduling" ADD CONSTRAINT "AppointmentScheduling_employedId_fkey" FOREIGN KEY ("employedId") REFERENCES "Session"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
